...
public class FamilyReserveApplication {
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Family Reserve REST API", "REST API for Family Reserve ", "1.0",
				"Terms of service", "Elizabeth Huston and Tracey Rainey", "Apache License Version 2.0",
